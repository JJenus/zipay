			...
			<div class="row mb-6">
				...
				<div class="col-lg-8 fv-row fv-plugins-icon-container">
					<select
						...
						data-select2-id="select2-data-1-k2of"
						tabindex="-1"
						aria-hidden="true"
						data-kt-initialized="1"
					>
						<option value="" data-select2-id="select2-data-3-jogj">
							Select a Country...
						</option>
					...
					><span
						...
						dir="ltr"
						data-select2-id="select2-data-2-xvrf"
						style="width: 100%"
						><span class="selection"
							><span
								...
								tabindex="0"
								aria-disabled="false"
								aria-labelledby="select2-country-qe-container"
								aria-controls="select2-country-qe-container"
								><span
									class="select2-selection__rendered"
									id="select2-country-qe-container"
									role="textbox"
									aria-readonly="true"
			...
			<div class="row mb-6">
				...
				<div class="col-lg-8 fv-row fv-plugins-icon-container">
					...
					<select
						...
						data-select2-id="select2-data-4-migt"
						tabindex="-1"
						aria-hidden="true"
						data-kt-initialized="1"
					>
						<option value="" data-select2-id="select2-data-6-uz73">
							Select a Language...
						</option>
						<option data-kt-flag="flags/indonesia.svg" value="id">
					...
					><span
						class="select2 select2-container select2-container--bootstrap5"
						dir="ltr"
						data-select2-id="select2-data-5-lgwm"
						style="width: 100%"
						><span class="selection"
							><span
								...
								tabindex="0"
								aria-disabled="false"
								aria-labelledby="select2-language-z1-container"
								aria-controls="select2-language-z1-container"
								><span
									class="select2-selection__rendered"
									id="select2-language-z1-container"
									role="textbox"
									aria-readonly="true"
			...
			<div class="row mb-6">
				...
				<div class="col-lg-8 fv-row fv-plugins-icon-container">
					<select
						...
						class="form-select form-select-solid form-select-lg select2-hidden-accessible"
						data-select2-id="select2-data-7-ghqt"
						tabindex="-1"
						aria-hidden="true"
						data-kt-initialized="1"
					>
						<option value="" data-select2-id="select2-data-9-ugpn">
							Select a Timezone..
						</option>
						<option
					...
					><span
						class="select2 select2-container select2-container--bootstrap5"
						dir="ltr"
						data-select2-id="select2-data-8-476a"
						style="width: 100%"
						><span class="selection"
							><span
								class="select2-selection select2-selection--single form-select form-select-solid form-select-lg"
								...
								tabindex="0"
								aria-disabled="false"
								aria-labelledby="select2-timezone-lv-container"
								aria-controls="select2-timezone-lv-container"
								><span
									class="select2-selection__rendered"
									id="select2-timezone-lv-container"
									role="textbox"
									aria-readonly="true"
									title="Select a timezone.."
									><span
										class="select2-selection__placeholder"
										>Select a timezone..</span
									></span
								><span
									class="select2-selection__arrow"
									role="presentation"
			...
			<div class="row mb-6">
				...
				<div class="col-lg-8 fv-row">
					<select
						...
						class="form-select form-select-solid form-select-lg select2-hidden-accessible"
						data-select2-id="select2-data-10-d0p3"
						tabindex="-1"
						aria-hidden="true"
						data-kt-initialized="1"
					>
						<option value="" data-select2-id="select2-data-12-coyb">
							Select a currency..
						</option>
						<option
							data-kt-flag="flags/united-states.svg"
							value="USD"
							data-select2-id="select2-data-117-m9vr"
						>
							USD&nbsp;-&nbsp;USA dollar
						</option>
						<option
							data-kt-flag="flags/united-kingdom.svg"
							value="GBP"
							data-select2-id="select2-data-118-kgtc"
						>
							GBP&nbsp;-&nbsp;British pound
						</option>
						<option
							...
							value="AUD"
							data-select2-id="select2-data-119-nlnd"
						>
						...
						<option
							...
							value="JPY"
							data-select2-id="select2-data-120-9323"
						>
							JPY&nbsp;-&nbsp;Japanese yen
						</option>
						<option
							...
							value="SEK"
							data-select2-id="select2-data-121-809k"
						>
							SEK&nbsp;-&nbsp;Swedish krona
						</option>
						<option
							...
							value="CAD"
							data-select2-id="select2-data-122-z4sj"
						>
							CAD&nbsp;-&nbsp;Canadian dollar
						</option>
						<option
							...
							value="CHF"
							data-select2-id="select2-data-123-flyw"
						>
							CHF&nbsp;-&nbsp;Swiss franc
						</option></select
					><span
						...
						dir="ltr"
						data-select2-id="select2-data-11-5dlk"
						style="width: 100%"
						><span class="selection"
							><span
								class="select2-selection select2-selection--single form-select form-select-solid form-select-lg"
								...
								tabindex="0"
								aria-disabled="false"
								aria-labelledby="select2-currnecy-nh-container"
								aria-controls="select2-currnecy-nh-container"
								><span
									class="select2-selection__rendered"
									id="select2-currnecy-nh-container"
									role="textbox"
									aria-readonly="true"
