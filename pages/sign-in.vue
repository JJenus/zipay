		...
		<div class="d-flex flex-column flex-root" id="kt_app_root">
			...
			<div class="d-flex flex-column flex-lg-row flex-column-fluid">
				...
				>
					<!--begin::Content-->
					<div
						class="d-flex flex-column flex-center p-6 p-lg-10 w-100"
					>
						<!--begin::Logo-->
						...
						>
							...
							<a
								href="#"
								class="opacity-75-hover text-warning fw-semibold me-1"
								>the blogger</a
							>
					...
					>
						...
						<div class="w-lg-500px p-10">
							...
							<form
								...
								novalidate
								id="kt_sign_in_form"
								data-kt-redirect-url="/keen/demo2/../demo2/index.html"
								action="#"
							>
								<!--begin::Heading-->
