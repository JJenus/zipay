			...
			<div class="card-toolbar">
				<div class="my-1 me-4">
					...
					<select
						...
						data-select2-id="select2-data-1-mxj5"
						tabindex="-1"
						aria-hidden="true"
					...
					>
						...
						<option value="4">24 Hours</option></select
					><span
						class="select2 select2-container select2-container--bootstrap5"
						dir="ltr"
						data-select2-id="select2-data-2-mx2z"
						style="width: 100%"
						><span class="selection"
							><span
								...
								tabindex="0"
								aria-disabled="false"
								aria-labelledby="select2-jiut-container"
								aria-controls="select2-jiut-container"
								><span
									class="select2-selection__rendered"
									id="select2-jiut-container"
									role="textbox"
									aria-readonly="true"
									title="1 Hours"
									>1 Hours</span
				...
				<a role="button" class="btn btn-sm btn-primary my-1"> View All </a>
			</div>
			<!--end::Toolbar-->
		</div>
		<!--end::Card header-->
